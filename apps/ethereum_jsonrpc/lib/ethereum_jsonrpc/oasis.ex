defmodule EthereumJSONRPC.Oasis do
  @moduledoc """
  Ethereum JSONRPC methods that are only supported by Oasis Emerald.
  """

  @behaviour EthereumJSONRPC.Variant

  @doc """
  Block reward contract beneficiary fetching is not supported currently for Oasis Emerald.
  ...
  @doc """
  Internal transaction fetching is not currently supported for Oasis Emerald.
  ...
  @doc """
  Pending transaction fetching is not supported currently for Oasis Emerald.
  ...
  @doc """
  Traces are not supported currently for Oasis Emerald.
